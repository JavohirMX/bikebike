            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    helpSection(
                        ...
                        body: "Tap Allow when iOS asks. AR Racecar only appears in Settings → Privacy → Local Network after you tap Continue — that's normal. If you denied access, reinstall the app or enable AR Racecar in Settings."
                    )
